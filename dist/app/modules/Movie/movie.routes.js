...
router.get("/", (0, auth_1.default)(client_1.Role.USER, client_1.Role.ADMIN), movie_controller_1.movieController.getAllMovie);
router.get("/:id", (0, auth_1.default)(client_1.Role.USER, client_1.Role.ADMIN), movie_controller_1.movieController.getMovieById);
